...
var lines = segmentData.components(separatedBy: "\n")

lines.map { line in
    let output = line.components(separatedBy: " | ").last!
    let components = output.components(separatedBy: " ")
    outputValues.append(contentsOf: components)
}


solve(partNumber: 1, input: outputValues, function: part1)

solve(partNumber: 2, input: lines, function: part2)
